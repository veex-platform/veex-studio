import { Database, Settings, Download, Play, Zap, ChevronDown, UserCircle, Activity } from 'lucide-react';
        ...
        <nav className="h-14 shrink-0 border-b border-white/5 bg-[#131722]/80 backdrop-blur-xl flex items-center justify-between px-4 z-50">
            <div className="flex items-center gap-6">
                ...
                >
                    ...
                    <span className="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-widest">Fleet Command</span>
                </button>
            </div>
